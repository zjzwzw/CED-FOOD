    ...
    def __init__(self, dataset_name, cfg=None):
        ...
        if cfg is not None:
            ...
            if 'RetinaNet' in cfg.MODEL.META_ARCHITECTURE:
                ...
                self._class_names = self._class_names[:self.num_known_classes]
    ...
    def evaluate(self):
        ...
        for predictions_per_rank in all_predictions:
            for clsid, lines in predictions_per_rank.items():
                    ####
                    index = clsid if clsid<self.unknown_class_index else self.unknown_class_index
                    ####
                    predictions[index].extend(lines)
        del all_predictions
